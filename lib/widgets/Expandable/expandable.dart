...
class _ExpandableWidgetState extends State<ExpandableWidget>
  ...
  void initState() {
    ...
    _headerAnimation = CurvedAnimation(
        parent: _headerAnimationController, curve: widget.curve);

    _childAnimationController = AnimationController(
        vsync: this, duration: Duration(milliseconds: widget.duration));

    _childAnimation =
        CurvedAnimation(parent: _childAnimationController, curve: widget.curve);
  ...
  void _expandOnChanged() {
    /// This method is triggered on tap
    isFirstTap = false;
    setState(() {
